import './style.css';
const PROFILE = {"day":"Day086","title":"Laundry Escape Window Compass","display_name_ja":"洗濯逃げ窓コンパス","one_sentence":"外出前に、洗濯物を外干しで逃げ切れるか部屋干しへ切り替えるか決めるツール","purpose_line_ja":"外出前に、洗濯物を外干しで逃げ切れるか部屋干しへ切り替えるか決めるツールです。","use_case_line_ja":"出かける前、空模様が怪しくて外干しのまま出るか迷う時に使います。","how_it_works_line_ja":"逃げ切り窓と切替案を見る。","core_action":"time_window_simulation","family":"laundry_weather_window","mechanic":"window_adjust","input_style":"editable_rows","output_style":"time_window_cards","output_label":"ここを見ればOKです","audience_promise":"出発前に外干し継続か部屋干し切替かを決められる。","publish_hook":"洗濯物の量、帰宅時刻、雨の不安、部屋干し余白を入れると、外干しで逃げ切れる窓と切替時刻が一本で見える。","engine":"brief_driven","interaction_archetype":"window_adjust","page_archetype":"weather_window_bar","ui_variant":"laundry-window","intro_variant":"laundry_escape_window","interaction_model":"editable_laundry_rows_to_weather_window","primary_layout":"laundry_time_window_workbench","result_presentation_style":"escape_window_bar_and_switch_cards","palette_motif":"洗濯逃げ窓スカイ","main_cta":"外干し前で試す","input_panel_title":"洗濯物と帰宅時刻を足す","sample_panel_title":"外出前の洗濯で試す","guide_panel_title":"逃げ切り窓の見どころ","hero_panel_label":"外干しの安全窓","output_shape":"weather_window_bar","state_model":"window_adjust_state","core_loop":"editable_rows -> window_adjust -> time_window_cards","component_pack":"weather_window_bar+time_window_cards","scaffold_id":"brief_canvas","single_shot_text_generator":false};
